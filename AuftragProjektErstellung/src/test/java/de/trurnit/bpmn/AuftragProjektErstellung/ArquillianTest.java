...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "AuftragProjektErstellung";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "AuftragProjektErstellung.war")
            ...
            .addPackages(false, "de.trurnit.bpmn.AuftragProjektErstellung") // not recursive to skip package 'nonarquillian'
